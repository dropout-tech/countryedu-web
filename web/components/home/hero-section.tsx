...
export function HeroSection() {
  ...
  useEffect(() => {
    ...
    const drawFogBase = (ctx: CanvasRenderingContext2D, w: number, h: number) => {
      ...
      /** 互動霧：暖白/晨光黃/淡桃粉，與新版 Hero 色場一致 */
      const lg = ctx.createLinearGradient(0, 0, 0, h)
      lg.addColorStop(0, "rgba(208, 225, 255, 0.5)")
      lg.addColorStop(0.24, "rgba(241, 239, 51, 0.58)")
      lg.addColorStop(0.56, "rgba(234, 239, 128, 0.5)")
      lg.addColorStop(0.78, "rgba(99, 199, 222, 0.34)")
      lg.addColorStop(1, "rgba(46, 93, 157, 0.32)")
      ctx.globalAlpha = 1
      ctx.fillStyle = lg
      ctx.fillRect(0, 0, w, h)

      const r1 = ctx.createRadialGradient(w * 0.35, h * 0.25, 0, w * 0.35, h * 0.25, w * 0.72)
      r1.addColorStop(0, "rgba(241, 239, 51, 0.42)")
      r1.addColorStop(0.55, "rgba(241, 239, 51, 0)")
      ctx.fillStyle = r1
      ctx.fillRect(0, 0, w, h)

      const r2 = ctx.createRadialGradient(w * 0.75, h * 0.65, 0, w * 0.75, h * 0.65, w * 0.68)
      r2.addColorStop(0, "rgba(111, 206, 226, 0.28)")
      r2.addColorStop(0.6, "rgba(111, 206, 226, 0)")
      ctx.fillStyle = r2
      ctx.fillRect(0, 0, w, h)

      const r3 = ctx.createRadialGradient(w * 0.5, h * 0.45, 0, w * 0.5, h * 0.45, w * 0.48)
      r3.addColorStop(0, "rgba(245, 244, 141, 0.96)")
      r3.addColorStop(0.18, "rgba(241, 239, 82, 0.88)")
      r3.addColorStop(0.36, "rgba(226, 235, 124, 0.72)")
      r3.addColorStop(0.58, "rgba(164, 199, 226, 0.5)")
      r3.addColorStop(0.78, "rgba(112, 197, 220, 0.22)")
      r3.addColorStop(0.96, "rgba(112, 197, 220, 0)")
      ...
      r4.addColorStop(0, "rgba(225, 237, 148, 0.28)")
      r4.addColorStop(0.7, "rgba(225, 237, 148, 0)")
      ctx.fillStyle = r4
      ctx.fillRect(0, 0, w, h)
      ...
      for (const [fx, fy, fr] of floats) {
        ...
        g.addColorStop(0, "rgba(236, 242, 178, 0.5)")
        g.addColorStop(0.62, "rgba(236, 242, 178, 0)")
        ctx.fillStyle = g
        ctx.fillRect(0, 0, w, h)
      }
      ctx.globalAlpha = 1
  ...
  return (
    <section
      ...
      style={{
        position: "relative",
        /* 與底層橫向漸層右側收斂色一致 */
        backgroundColor: HERO_PALETTE.navyInk,
      }}
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-0">
        {/* L0a 最底：暖黃晨光 → 淡桃粉過渡 → 深藍地平線（保留橫向色帶層次） */}
        <div
          className="absolute inset-0"
          style={{
            background: `
              linear-gradient(182deg,
                ${HERO_PALETTE.navyInk} 0%,
                ${HERO_PALETTE.horizonBlue} 20%,
                ${HERO_PALETTE.warmYellow} 52%,
                ${HERO_PALETTE.apricot} 64%,
                ${HERO_PALETTE.lightBlue} 84%,
                #58bad4 100%
              )
            `,
          }}
        ...
        >
          ...
          <g fill="rgba(230,239,255,0.78)" filter={`url(#hero-star-glow-${heroBgUid})`}>
        ...
        {/* L0：暖晨光 + 淡桃粉 + 冷藍地平線 mesh，疊在底層色帶上保留深度 */}
        <div
          className="absolute inset-0"
          style={{
            opacity: 0.88,
            ...
            background: `
              radial-gradient(ellipse 140% 96% at 50% 48%, rgba(241, 239, 51, 0.6) 0%, rgba(233, 238, 120, 0.34) 34%, rgba(140, 188, 223, 0.16) 62%, transparent 76%),
              radial-gradient(ellipse 130% 110% at 50% 92%, rgba(90, 188, 212, 0.32) 0%, rgba(46, 93, 157, 0.18) 42%, transparent 64%),
              radial-gradient(ellipse 118% 82% at 10% 6%, rgba(118, 157, 214, 0.3) 0%, transparent 56%),
              radial-gradient(ellipse 118% 82% at 90% 8%, rgba(118, 157, 214, 0.28) 0%, transparent 58%),
              radial-gradient(ellipse 92% 70% at 50% 12%, rgba(15, 20, 49, 0.42) 0%, transparent 66%),
              linear-gradient(188deg,
                oklch(0.3 0.05 264) 0%,
                oklch(0.45 0.08 254) 26%,
                oklch(0.9 0.2 108) 56%,
                oklch(0.72 0.12 197) 80%,
                oklch(0.62 0.1 215) 100%
              )
            `,
          }}
        />
        ...
        >
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, transparent 0%, rgba(241, 239, 51, 0.56) 40%, rgba(225, 236, 114, 0.4) 100%)",
                boxShadow: "0 0 90px 48px rgba(241, 239, 51, 0.22)",
              }}
            />
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, transparent 0%, rgba(150, 186, 220, 0.52) 50%, transparent 100%)",
                boxShadow: "0 0 78px 40px rgba(150, 186, 220, 0.18)",
              }}
            />
          </div>
          {/* 右上 */}
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, transparent 0%, rgba(226, 234, 107, 0.46) 50%, transparent 100%)",
                boxShadow: "0 0 60px 32px rgba(156, 192, 226, 0.18)",
              }}
            />
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, transparent 0%, rgba(150, 186, 220, 0.5) 50%, transparent 100%)",
              }}
            />
          </div>
          {/* 左下 */}
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, transparent 0%, rgba(101, 199, 222, 0.4) 50%, transparent 100%)",
                boxShadow: "0 0 56px 28px rgba(101, 199, 222, 0.16)",
              }}
            />
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, transparent 0%, rgba(101, 199, 222, 0.46) 50%, transparent 100%)",
              }}
            />
          </div>
          {/* 右下 */}
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, transparent 0%, rgba(46, 93, 157, 0.34) 50%, transparent 100%)",
                boxShadow: "0 0 52px 28px rgba(46, 93, 157, 0.16)",
              }}
            />
            <div
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(ellipse 72% 62% at 48% 44%, rgba(241, 239, 51, 0.32) 0%, rgba(225, 236, 114, 0.15) 48%, transparent 74%)",
            filter: "blur(76px)",
            opacity: 0.78,
          }}
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 58% at 52% 42%, rgba(213, 226, 112, 0.3) 0%, rgba(148, 186, 221, 0.14) 50%, transparent 74%)",
            filter: "blur(72px)",
            opacity: 0.62,
          }}
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(ellipse 68% 58% at 52% 52%, rgba(101, 199, 222, 0.24) 0%, rgba(46, 93, 157, 0.08) 52%, transparent 74%)",
            filter: "blur(70px)",
            opacity: 0.58,
          }}
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(ellipse 62% 54% at 50% 50%, rgba(149, 186, 220, 0.16) 0%, transparent 68%)",
            filter: "blur(82px)",
            opacity: 0.52,
          }}
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(ellipse 68% 60% at 40% 55%, rgba(101, 199, 222, 0.2) 0%, rgba(24, 40, 84, 0.1) 55%, transparent 76%)",
            filter: "blur(74px)",
            opacity: 0.55,
          }}
        ...
        />
        {/* 中心：略壓暗以托字，改為藍霧壓暗層（減厚重） */}
        <div
          className="absolute inset-0"
          style={{
            background:
              "radial-gradient(ellipse 92% 86% at 50% 45%, rgba(15, 20, 49, 0.34) 0%, rgba(24, 40, 84, 0.18) 38%, rgba(46, 93, 157, 0.1) 62%, transparent 84%)",
            opacity: 0.72,
          }}
        />
        {/* L1b 霧面柔光：暖白 / 淡桃 / 冷藍 擴散 */}
        <div
          className="absolute inset-0"
          style={{
            background:
              "radial-gradient(ellipse 90% 75% at 50% 28%, rgba(245, 244, 150, 0.18) 0%, rgba(241, 239, 51, 0.1) 32%, transparent 58%), radial-gradient(ellipse 80% 60% at 18% 72%, rgba(152, 189, 221, 0.1) 0%, transparent 55%), radial-gradient(ellipse 75% 55% at 84% 68%, rgba(101, 199, 222, 0.12) 0%, transparent 52%), radial-gradient(ellipse 120% 90% at 50% 100%, rgba(24, 40, 84, 0.18) 0%, transparent 55%)",
            filter: "blur(48px)",
            opacity: 0.82,
            mixBlendMode: "soft-light" as const,
          }}
          ...
          <svg viewBox="0 0 1200 900" className="h-full w-full" preserveAspectRatio="xMidYMid slice" aria-hidden>
            <defs>
              <pattern id={`map-blocks-${heroBgUid}`} width="56" height="56" patternUnits="userSpaceOnUse">
                <path d="M 56 0 L 0 0 0 56" fill="none" stroke="rgba(164, 196, 225, 0.14)" strokeWidth="0.5" />
              </pattern>
            </defs>
            <rect width="1200" height="900" fill={`url(#map-blocks-${heroBgUid})`} opacity={0.38} />
            <g opacity={0.12} fill="none" stroke="rgba(101, 199, 222, 0.36)" strokeWidth="0.55" strokeLinecap="round">
          ...
          <svg viewBox="0 0 1200 900" className="h-full w-full" preserveAspectRatio="xMidYMid slice" aria-hidden>
            <defs>
              ...
              <linearGradient id={`ribbon-a-${heroBgUid}`} x1="0" y1="100%" x2="100%" y2="0%" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="rgba(244, 242, 103, 0.62)" />
                <stop offset="35%" stopColor="rgba(225, 236, 117, 0.5)" />
                <stop offset="100%" stopColor="rgba(101, 199, 222, 0.56)" />
              </linearGradient>
            </defs>
        ...
        {/* L4 色域裝飾：暖光 / 粉霧 / 淡藍高光，不搶字 */}
        <div
          className="absolute inset-0"
          style={{
            opacity: 0.09,
            background:
              "linear-gradient(124deg, transparent 0%, transparent 28%, rgba(241, 239, 51, 0.16) 44%, rgba(152, 189, 221, 0.1) 54%, transparent 62%, transparent 100%)",
          }}
        />
        <div
          ...
          style={{
            opacity: 0.12,
            background:
              "linear-gradient(148deg, rgba(225, 236, 116, 0.24) 0%, rgba(152, 189, 221, 0.12) 55%, rgba(24, 40, 84, 0.08) 100%)",
            filter: "blur(12px)",
          }}
        />
        <div
          ...
          style={{
            opacity: 0.11,
            background:
              "linear-gradient(138deg, rgba(101, 199, 222, 0.2) 0%, rgba(46, 93, 157, 0.14) 50%, rgba(15, 20, 49, 0.08) 100%)",
            filter: "blur(14px)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 58% 48% at 50% 44%, rgba(246,245,166,0.1) 0%, transparent 62%), radial-gradient(ellipse 120% 100% at 50% 50%, transparent 42%, rgba(15, 20, 49, 0.24) 100%)",
            opacity: 0.92,
          }}
        />
        <div
        ...
        >
          <g pointerEvents="none">
            ...
            <circle
              ...
              cy={820}
              r="5.5"
              fill={HERO_PALETTE.glowGold}
              stroke="rgba(236,244,255,0.65)"
              strokeWidth="1"
              style={{ filter: "drop-shadow(0 0 12px rgba(245, 239, 104, 0.9))" }}
            />
          </g>
        </svg>
      </div>
      ...
      <div className="relative z-20 flex min-h-screen flex-col items-center justify-center px-4">
        <div className="mx-auto max-w-4xl text-center">
          {/* Badge */}
          <motion.div
            className="mb-10 inline-flex items-center gap-3.5 rounded-full border border-[#f5ef68]/40 bg-[#111a3f]/55 px-7 py-3.5 text-base font-medium text-[#fffdf8] shadow-[0_0_0_1px_rgba(245,239,104,0.12)_inset] md:mb-12 md:gap-4 md:px-9 md:py-4 md:text-lg"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.3, ease: "easeOut" }}
          >
            <motion.span
              className="h-3 w-3 shrink-0 rounded-full bg-[#f5ef68] md:h-3.5 md:w-3.5"
              animate={{ scale: [1, 1.2, 1], opacity: [0.8, 1, 0.8] }}
              transition={{ duration: 2.5, repeat: Infinity }}
            />
            <span className="rounded-md bg-[#f5ef68]/22 px-2.5 py-1 text-xs font-bold tracking-wide text-[#f5ef68] md:px-3 md:py-1.5 md:text-sm">
              NEW
            </span>
            賦能青年選擇力
          </motion.div>
      ...
      >
        <motion.button
          ...
          className="flex flex-col items-center gap-3 text-[#fffdf8] hover:text-[#f5ef68] transition-colors"
          animate={{ y: [0, 8, 0] }}
          transition={{ duration: 2.5, repeat: Infinity, ease: "easeInOut" }}
        >
          <span className="text-sm font-medium tracking-wide">向下探索</span>
          <div className="h-12 w-px bg-gradient-to-b from-[#f5ef68]/85 to-transparent" />
        </motion.button>
      </motion.div>
